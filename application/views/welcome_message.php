...
<div class="container" style="margin-top: 32px">
	<div class="row">
		<div class="col s12 m12 l12 xl12 z-depth-4">
			<div class="slider">
				<ul class="slides">
					<li><img src="<?=base_url()?>assets/img/slider/1.jpg"></li>
					<li><img src="<?=base_url()?>assets/img/slider/2.jpg"></li>
					<li><img src="<?=base_url()?>assets/img/slider/3.png"></li>
					<li><img src="<?=base_url()?>assets/img/slider/4.jpg"></li>
					<li><img src="<?=base_url()?>assets/img/slider/5.jpg"></li>
					<li><img src="<?=base_url()?>assets/img/slider/6.jpg"></li>
					<li><img src="<?=base_url()?>assets/img/slider/7.jpg"></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col s12 m12 l8 xl8 z-depth-4">
			<h3>Visi</h3>
			<p>
		...
		<div class="col s12 m12 l4 xl4">
			<div class="row">
				<div class="col l11 xl11 push-l1 push-xl1 z-depth-4">
